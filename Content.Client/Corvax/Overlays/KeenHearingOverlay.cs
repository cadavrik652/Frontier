...
namespace Content.Client.Corvax.Overlays;
...
public sealed class KeenHearingOverlay : IgnoreLightVisionOverlay
{
    ...
    private List<string> _blacklistComponentNames = new List<string> { };
    ...
    public KeenHearingOverlay(float showRadius, float closeShowRadius) : base(showRadius, closeShowRadius)
    {
        ...
        _sprite = new SpriteSpecifier.Rsi(new("/Textures/Corvax/Effects/keen_vision_marker.rsi"), "pulse");
