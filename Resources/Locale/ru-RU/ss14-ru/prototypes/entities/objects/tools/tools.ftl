...
ent-RCD = УБС
    .desc = Новейшее устройство быстрого строительства, которое может быстро размещать и демонтировать стены, полы и шлюзы.
ent-RCDEmpty = { ent-RCD }
    .suffix = Пустой
    .desc = { ent-RCD.desc }
ent-RCDRecharging = экспериментальный УБС
    .desc = Блюспейс-улучшенное УБС, пассивно регенерирующий заряды.
    .suffix = Автозарядка
ent-RCDExperimental = экспериментальное УБС
    .desc = Блюспейс-улучшенное УБС, пассивно регенерирующий заряды.
    .suffix = Адмемы
ent-RCDAmmo = картридж УБС
    .desc = Картридж для УБС.
ent-Shovel = лопата
